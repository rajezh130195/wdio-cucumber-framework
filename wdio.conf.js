...
exports.config = {
    ...
    capabilities: [{
        ...
        'goog:chromeOptions': {
            args: ['--disable-gpu', '--window-size=1920,1080', '--disable-bidirectional-logging']
        }
    }],
    ...
    reporters: [
        'spec', // Optional: console reporter
        ['allure', {
    ...
    onComplete: function (exitCode, config, capabilities, results) {
        ...
        const environmentProperties = `browserName=Chrome\nplatform=MAC\nApplicationUrl='https://team.quickbase.com/'`;
